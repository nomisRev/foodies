...
/**
 * Wrapper around a RabbitMQ message providing the deserialized value and manual acknowledgment
 * controls.
 *
...
class Message<A>(val value: A, private val delivery: Delivery, private val channel: Channel) {
    ...
    /**
     * Negatively acknowledges the message without requeuing. The message will be discarded or sent
