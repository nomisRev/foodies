...
Before you finish **ALWAYS** commit your changes:
 1. Commit the changes with an appropriate brief but descriptive message
 2. Push the changes to **your branch only**
 3. Check there are no untracked files 
