...
import dasniko.testcontainers.keycloak.KeycloakContainer as KeycloakTestContainer
import de.infix.testBalloon.framework.core.TestSuite
import org.testcontainers.utility.MountableFile
import java.nio.file.Paths

class KeycloakContainer : KeycloakTestContainer("quay.io/keycloak/keycloak:26.0") {
    init {
