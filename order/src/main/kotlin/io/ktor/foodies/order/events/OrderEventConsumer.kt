...
fun orderEventConsumers(
    ...
    listOf(
        run {
            ...
            subscriber
                .subscribe<StockConfirmedEvent>(queueName) {
        ...
        run {
            ...
            subscriber
                .subscribe<StockRejectedEvent>(queueName) {
                    queueDeclare(queueName, true, false, false, null)
                    queueBind(queueName, exchange, routingKey)
                }
        ...
        run {
            ...
            subscriber
                .subscribe<OrderPaymentFailedEvent>(queueName) {
                    queueDeclare(queueName, true, false, false, null)
                    queueBind(queueName, exchange, routingKey)
                }
        ...
        run {
            ...
            subscriber
                .subscribe<OrderStatusChangedEvent>(queueName) {
                    queueDeclare(queueName, true, false, false, null)
                    queueBind(queueName, exchange, routingKey)
                }
