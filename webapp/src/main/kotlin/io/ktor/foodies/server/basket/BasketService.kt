...
class HttpBasketService(
    ...
    override suspend fun updateItemQuantity(token: String, itemId: String, quantity: Int): CustomerBasket =
    ...
    override suspend fun removeItem(token: String, itemId: String): CustomerBasket =
        httpClient.delete("$basketBaseUrl/basket/items/$itemId") {
            bearerAuth(token)
        }.body()
