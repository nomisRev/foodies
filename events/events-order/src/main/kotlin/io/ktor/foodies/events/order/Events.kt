...
data class OrderCreatedEvent(
    ...
    @Transient override val routingKey: RoutingKey<OrderCreatedEvent> = key()
...
data class OrderCancelledEvent(
    ...
    @Transient override val routingKey: RoutingKey<OrderCancelledEvent> = key()
...
data class OrderStatusChangedEvent(
    ...
    @Transient override val routingKey: RoutingKey<OrderStatusChangedEvent> = key()

    companion object {
        fun key(): RoutingKey<OrderStatusChangedEvent> =
            RoutingKey("order.status-changed", serializer())
    }
}
...
data class OrderAwaitingValidationEvent(
    ...
    @Transient override val routingKey: RoutingKey<OrderAwaitingValidationEvent> = key()

    companion object {
        fun key(): RoutingKey<OrderAwaitingValidationEvent> =
            RoutingKey("order.awaiting-validation", serializer())
    }
}
...
data class StockReturnedEvent(val orderId: Long, val items: List<StockValidationItem>) :
    ...
    @Transient override val routingKey: RoutingKey<StockReturnedEvent> = key()
...
data class OrderStockConfirmedEvent(
    ...
    @Transient override val routingKey: RoutingKey<OrderStockConfirmedEvent> = key()

    companion object {
        fun key(): RoutingKey<OrderStockConfirmedEvent> =
            RoutingKey("order.stock-confirmed", serializer())
    }
}
