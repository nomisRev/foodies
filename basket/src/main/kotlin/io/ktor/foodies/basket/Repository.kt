...
class RedisBasketRepository(private val redis: RedisCoroutinesCommands<String, String>) :
    BasketRepository {
...
/**
 * Creates a Redis client and returns both the client (for lifecycle management) and the
 * coroutine-based commands interface.
 */
@OptIn(ExperimentalLettuceCoroutinesApi::class)
fun createRedisClient(
    config: RedisConfig
): Pair<RedisClient, StatefulRedisConnection<String, String>> {
    val redisUri =
